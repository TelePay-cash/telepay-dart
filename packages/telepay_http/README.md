...
[TelePay][telepay_link] client for Dart language, to easily process cryptocurrency payments using classic http client [http](http_package_link).

## Getting Started

Check the full example [here](https://github.com/telepay-cash/telepay-dart/blob/main/packages/telepay_http/example/lib/main.dart).
...
```yaml
dependencies:
    telepay_http: <version>
```

### Make Your First Request

The first thing is to create an instance of `TelePayHttp` for later use, which receives two parameters, your API private key and an instance of http client.

```dart
  final telepay = TelePayHttp(secretApiKey: 'your_secret_api_key', http: http);
```
...
[pub_badge]: https://img.shields.io/pub/v/telepay_http.svg
[pub_link]: https://pub.dartlang.org/packages/telepay_http
[license_link]: https://opensource.org/licenses/MIT
[very_good_analysis_badge]: https://img.shields.io/badge/style-very_good_analysis-B22C89.svg
[very_good_analysis_link]: https://pub.dev/packages/very_good_analysis
[telepay_link]: https://telepay.cash
[http_package_link]: https://pub.dev/packages/http
